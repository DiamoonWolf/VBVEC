...
#Region " Colors"
    ...
    Private AlertColor As Color = Color.FromArgb(255, 153, 51)
    Private AlertText As Color = Color.FromArgb(255, 255, 102)
#End Region
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        With G
            ...
            Select Case K
                ...
                Case _Kind.Alert
                    '-- Base
                    .FillRectangle(New SolidBrush(AlertColor), Base)

                    '-- Ellipse
                    .FillEllipse(New SolidBrush(AlertText), New Rectangle(8, 9, 24, 24))
                    .FillEllipse(New SolidBrush(AlertColor), New Rectangle(10, 11, 20, 20))

                    '-- Info Sign
                    .DrawString("ü", New Font("Wingdings", 22), New SolidBrush(AlertText), New Rectangle(7, 7, W, H), NearSF)
                    .DrawString(Text, Font, New SolidBrush(AlertText), New Rectangle(48, 12, W, H), NearSF)

                    '-- X button
                    '.FillEllipse(New SolidBrush(Color.FromArgb(35, Color.Black)), New Rectangle(W - 32, H - 29, 17, 17))
                    '.DrawString("r", New Font("Marlett", 8), New SolidBrush(AlertColor), New Rectangle(W - 30, 17, W, H), NearSF)
